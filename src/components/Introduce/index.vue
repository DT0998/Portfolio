            ...
            <div class="flex items-center h-[42px] md:h-[80px]">
                <div class="h-full">
                    <div class="w-full h-full flex items-center animation-content overflow-hidden relative z-[1]">
                        <div class="introduce-top w-full absolute top-0 z-[10] w-full h-full animation-slideltr animation-slideltr-intro">
                        </div>
                ...
                <span class="intro-line h-[2px] ml-[20px] w-full"
                    :style="[isDark ? darkThemeStyleIntroLine : lightThemeStyleIntroLine]">
                </span>
            </div>
            <div class="flex items-center h-[42px] md:h-[80px] mt-[5px]">
                <div class="h-full relative z-[1] overflow-hidden">
                    <div class="introduce w-full absolute top-0 z-[10] w-full h-full animation-slideltr animation-slideltr-intro"></div>
