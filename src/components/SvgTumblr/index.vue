...
<template>
    <svg viewBox="0 0 512.002 512.002" height="29" width="48" :class="{ 'text-white': isDark, 'text-black': !isDark }"
        class="cursor-pointer logo">
        <defs>
            <clipPath id="clip-path" transform="translate(0 0)">
                <path d="M412.537,391.313c-2.664-1.442-5.913-1.303-8.455,0.365c-23.37,15.352-47.02,23.134-70.288,23.134
